...
const Home = ({email , setEmail}) => {
    ...
    return (
        <>
            ...
            <h1 className='text-9xl text-rose-950 font-serif font-black'>Quix</h1>
            <br />
            <h3 className='text-xl '>Challenge your ability</h3>

            <br /><br />
            <div className="rules m-2">
                <h2 className='text-4xl font-black text-red-500 text-transform: uppercase'>Rules</h2>
                <ol className='list-decimal'>
                    ...
                    <li>You can use the <span className='font-bold text-green-500'>Submit</span> button to submit the test. Alternatively, <span className='font-bold text-red-500'>the test would be auto-submitted once the time is over</span></li>
            ...
            <form onSubmit={handleForm}>
                ...
                <br />
                <button className='m-3 bg-gray-600 hover:bg-white hover:text-gray-600 text-white py-1 px-4 border border-gray-400 rounded shadow' type='submit'>Proceed Ahead</button>
